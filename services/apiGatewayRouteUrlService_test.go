...
var GwCid3 int64
var GwCidStr3 string
var RTID2 int64
var RUID int64
var RUID2 int64

func TestGatewayRouteURLService_AddClient(t *testing.T) {
	GwCid3 = 5544559994444466666
	GwCidStr3 = "5544559994444466666"
...
func TestGatewayRouteURLService_GetRouteURL(t *testing.T) {
	...
	res := r.GetRouteURL(strconv.FormatInt(RUID, 10), strconv.FormatInt(RTID2, 10), GwCidStr3)
	fmt.Print("res: ")
	fmt.Println(res)
...
func TestGatewayRouteURLService_GetRouteURLList(t *testing.T) {
	...
	res := r.GetRouteURLList(strconv.FormatInt(RTID2, 10), GwCidStr3)
	fmt.Print("res: ")
	fmt.Println(res)
	if len(*res) < 2 {
		t.Fail()
...
func TestGatewayRouteURLService_DeleteRouteURL2(t *testing.T) {
	...
	res := r.DeleteRouteURL(strconv.FormatInt(RUID2, 10), strconv.FormatInt(RTID2, 10), GwCidStr3)
	fmt.Print("res: ")
	fmt.Println(res)
	if res.Success != true {
		t.Fail()
...
func TestGatewayRouteURLService_DeleteClient(t *testing.T) {
	var c GatewayClientService
	c.ClientID = "403"
	c.Host = "http://localhost:3011"
	c.Token = tempToken

	res := c.DeleteClient(GwCidStr3)
	fmt.Print("res: ")
	fmt.Println(res)
	if res.Success != true {
