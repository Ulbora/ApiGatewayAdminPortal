...
func (r *GatewayRouteURLService) AddRouteURL(url *GatewayRouteURL) *GatewayResponse {
	...
	var addURL = r.Host + "/rs/gwRouteUrlSuper/add"
...
func (r *GatewayRouteURLService) UpdateRouteURL(url *GatewayRouteURL) *GatewayResponse {
	var rtn = new(GatewayResponse)
	var upURL = r.Host + "/rs/gwRouteUrlSuper/update"
...
func (r *GatewayRouteURLService) ActivateRouteURL(url *GatewayRouteURL) *GatewayResponse {
	var rtn = new(GatewayResponse)
	var upURL = r.Host + "/rs/gwRouteUrlSuper/activate"
...
func (r *GatewayRouteURLService) GetRouteURL(id string, routeID string, clientID string) *GatewayRouteURL {
	...
	var gURL = r.Host + "/rs/gwRouteUrlSuper/get/" + id + "/" + routeID + "/" + clientID
	//fmt.Println(gURL)
...
func (r *GatewayRouteURLService) DeleteRouteURL(id string, routeID string, clientID string) *GatewayResponse {
	var rtn = new(GatewayResponse)
	var gURL = r.Host + "/rs/gwRouteUrlSuper/delete/" + id + "/" + routeID + "/" + clientID
	//fmt.Println(gURL)
